...
class AuthorizeNetCIM extends AuthorizeNetRequest
{
    ...
    public function createCustomerProfile($customerProfile, $validationMode = "none")
    {
	 ...
	 /**
     * Create a customer profile from transaction.
     *
    ...
    protected function _setPostString()
    {
        ...
        //echo  '<pre>'.htmlentities($this->_xml->asXML()). '</pre>';
...
class AuthorizeNetCIM_Response extends AuthorizeNetXMLResponse
{
    ...
    {
		//echo  '<pre>'.htmlentities($this->xml->asXML()). '</pre>';
    ...
    {
		$error = (array)$this->xml->messages->message;
        return "code: ".$error["code"]." reason: ".$error["text"];
    ...
    {
		$resultCode = $this->xml->messages->resultCode;
        return $resultCode;
